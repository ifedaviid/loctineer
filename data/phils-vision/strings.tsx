...
export const EVENT_COVERAGE = "Wedding Event Coverage";
export const WEDDING_COVERAGE_PHOTO = "Wedding Photo Coverage";
export const WEDDING_COVERAGE_VIDEO = "Wedding Video Coverage";
export const WEDDING_COVERAGE_COMBO = "Wedding Full Coverage";
